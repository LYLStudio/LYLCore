namespace LStudio.Core
{
    ...
    public static class BinaryStringHelper
    {
        ...
        public static string ByteArrayToHexString(byte[] buffer, int bytesPerLine, string separator)
        {
...
namespace LStudio.Core
{
    public static class BinaryStringExtensions
    {
        ...
        {
            return BinaryStringHelper.ByteArrayToHexString(buffer, 16, "");
        }

        public static string ToHexString(this byte[] buffer, int bytesPerLine)
        {
            return BinaryStringHelper.ByteArrayToHexString(buffer, bytesPerLine, "");
        }
        ...
        /// <returns></returns>
        public static string ToHexString(this byte[] buffer, int bytesPerLine, string separator)
        {
